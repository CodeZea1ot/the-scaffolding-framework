...
function tsf_custom_weapons:scripts/add_objectives

#Optional init confirmation message
tellraw @a [{"text":"Custom Weapons Module Initialized","color":"yellow"}]

#Set the initialization objective value to 1, which ensures this function is only called once
scoreboard players set $init tsf_CustWeapons 1
